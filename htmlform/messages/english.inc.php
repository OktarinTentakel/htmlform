...
define('MSG_DATE', '"%name%" has to be a valid date following the syntax &quot;mm/dd/yyyy&quot;.');
define('MSG_DATE_ISO', '"%name%" has to be a valid date following the ISO-syntax &quot;yyyy-mm-dd&quot;.');
define('MSG_DATE_DE', '"%name%" has to be a valid date following the German syntax &quot;dd.mm.yyyy&quot;.');
