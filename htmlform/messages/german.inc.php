...
define('MSG_DATE', '"%name%" muss ein g&uuml;ltiges Datum entsprechend der Syntax &quot;mm/dd/yyyy&quot; sein.');
define('MSG_DATE_ISO', '"%name%" muss ein g&uuml;ltiges Datum entsprechend der ISO-Syntax &quot;yyyy-mm-dd&quot; sein.');
define('MSG_DATE_DE', '"%name%" muss ein g&uuml;ltiges Datum entsprechend der deutschen Syntax &quot;dd.mm.yyyy&quot; sein.');
